export class GrpcInterop {
    static createGame(call: any, callback: any): void;
    static startGame(call: any): void;
    static startMetrics(call: any): void;
    static restartGame(call: any, callback: any): void;
